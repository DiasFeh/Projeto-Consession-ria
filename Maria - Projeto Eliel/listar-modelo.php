...
if($qtd > 0){
    ...
    while($row = $res->fetch_object()){
        ...
        print "<td>
            ...
            <button class='btn btn-danger' onclick=\"if(confirm('Tem certeza que deseja excluir?')){location.href='?page=salvar-modelo&acao=excluir&id_modelo={$row->id_modelo}'}\">Excluir</button>
        </td>";
        print "</tr>";
    }
    print "</table>";
