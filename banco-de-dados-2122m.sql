...
-- -----------------------------------------------------
-- Schema concessionaria1
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema concessionaria1
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `concessionaria1` DEFAULT CHARACTER SET utf8 ;
USE `concessionaria1` ;

-- -----------------------------------------------------
-- Table `concessionaria1`.`cliente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `concessionaria1`.`cliente` (
...
-- -----------------------------------------------------
-- Table `concessionaria1`.`funcionario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `concessionaria1`.`funcionario` (
...
-- -----------------------------------------------------
-- Table `concessionaria1`.`marca`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `concessionaria1`.`marca` (
...
-- -----------------------------------------------------
-- Table `concessionaria1`.`modelo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `concessionaria1`.`modelo` (
  ...
  CONSTRAINT `fk_modelo_marca`
    ...
    REFERENCES `concessionaria1`.`marca` (`id_marca`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `concessionaria1`.`venda`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `concessionaria1`.`venda` (
  ...
  CONSTRAINT `fk_venda_cliente1`
    ...
    REFERENCES `concessionaria1`.`cliente` (`id_cliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_venda_funcionario1`
    FOREIGN KEY (`funcionario_id_funcionario`)
    REFERENCES `concessionaria1`.`funcionario` (`id_funcionario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_venda_modelo1`
    FOREIGN KEY (`modelo_id_modelo`)
    REFERENCES `concessionaria1`.`modelo` (`id_modelo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
